...
/*   Updated: 2022/05/23 19:14:43 by zmoussam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	moves_enemie_red(t_long *so, t_cordinates e, int *bolean)
{
	...
	randd = (rand() % (u - l + 1) + l);
	if (randd == 1 && r == 1)
		moves_enemie_left(so, 'R', e);
	if (randd == 2 && r == 2)
		moves_enemie_down(so, 'R', e);
	if (randd == 3 && r == 3)
		moves_enemie_right(so, 'R', e);
	if (randd == 4 && r == 4)
		moves_enemie_up(so, 'R', e);
}
...
void	moves_enemie_green(t_long *so, t_cordinates e, int *bolean)
{
	...
	randd = (rand() % (u - l + 1) + l);
	if (randd == 1 && r == 1)
		moves_enemie_left(so, 'G', e);
	else if (randd == 2 && r == 2)
		moves_enemie_down(so, 'G', e);
	else if (randd == 3 && r == 3)
		moves_enemie_right(so, 'G', e);
	else if (randd == 4 && r == 4)
		moves_enemie_up(so, 'G', e);
}
